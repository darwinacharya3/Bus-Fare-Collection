...
//             if (phoneController.text.length == 10) {
//               final String fullPhoneNumber = countryCode.dialCode + phoneController.text;
//               authController.phoneAuth(fullPhoneNumber); // Send OTP to the entered number
//               Get.to(() => const OtpVerificationScreen()); // Navigate to OTP Verification Screen
//             } else {
//               // Show an alert if the phone number is not 10 digits long
//               ScaffoldMessenger.of(Get.context!).showSnackBar(
...
// Widget loginWidget(CountryCode countryCode, Function onCountryChange) {
//   // Controller to capture the input phone number
//   final TextEditingController phoneController = TextEditingController();
...
//         InkWell(
//           onTap: () {
//             // Check if the phone number has exactly 10 digits before navigating
//             if (phoneController.text.length == 10) {
...
//           textWidget(text:AppConstants.enterMobileNumber,fontSize: 22, fontWeight: FontWeight.bold),
//            const SizedBox(height: 40,),
